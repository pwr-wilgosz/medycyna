...
class ReceiptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receipt" do
    assert_difference('Receipt.count') do
      post receipts_url, params: { receipt: { closed: @receipt.closed, user_id: @receipt.user_id } }
    end
  ...
  test "should update receipt" do
    patch receipt_url(@receipt), params: { receipt: { closed: @receipt.closed, user_id: @receipt.user_id } }
